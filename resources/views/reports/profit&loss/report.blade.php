        ...
        <div class="mb-5 page-titles">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-none d-md-flex align-items-center justify-content-end">
                    <input class="w-auto border-0 form-control bg-primary-subtle" type="date" id="currentDate"
                        value="" name="date">
                </div>
                                    ...
                                    <div class="pt-3 row">
                                        <div class="col-md-12">
                                            <div>
                                                <address>
                                                    <div
                                                        class="gap-2 mb-4 text-center d-flex flex-column flex-sm-row align-items-center justify-content-sm-start text-sm-start">
                                                        <img src="{{ $church->logo == '' ? 'assets/images/logos/logo.png' : asset('storage/' . $church->logo) }}"
                                                            width="120px" alt="logo">


                                                        <div class="">
                                                            <h3>{{ $church->name }}</h3>
                                                            <p class="ms-1">{{ $church->address }}, {{ $church->city }},
                                                                {{ $church->region }}, {{ $church->country }}. <br>
                                            ...
                                            <div class="mt-6 table-responsive">
                                                ...
                                                <table class="table">
                                                    ...
                                                    @foreach ($revenues as $account)
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right">
                                                                {{ number_format($account->total_credit - $account->total_debit, 2) }}
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    @endforeach
                                                    <tr>
                                                        <th>Total</th>
                                                        <td></td>
                                                        <th style="text-align: right">{{ number_format($totalRevenue, 2) }}
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align: right">{{ number_format($netIncome, 2) }}
                                                        </th>
                                                    </tr>
