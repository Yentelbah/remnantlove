<div id="deleteCommentModal" class="modal fade" tabindex="-1" aria-labelledby="danger-header-modalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('comment.destroy') }}" method="POST">
          ...
          @method('DELETE')
              ...
              <input hidden type="text" name="selectedId" class="form-control" id="del_comment_selectedId">

              <p class="mb-0">If you delete the comment it will be gone forever. Are you sure you want to
                proceed?</p>
