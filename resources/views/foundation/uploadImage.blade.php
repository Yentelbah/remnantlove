    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="member-image-upload" action="{{ route('foundation.image.upload') }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <input type="hidden" name="member_id" value="{{ $foundationSchool->id }}"> <!-- This holds the member ID -->
