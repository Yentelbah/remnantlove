<div id="recordModal" class="modal fade" tabindex="-1" aria-labelledby="info-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header modal-colored-header">
                <h5 class="modal-title" id="success-header-modalLabel">Record Attendance to <span name="name" id="ser_name"></span></h5>
            ...
            @csrf
                <input type="hidden" id="ser_selectedId" name="service_id">
