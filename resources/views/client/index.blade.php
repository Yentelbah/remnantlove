...
@section('title')
    <title>FaithFlow -- Organisations</title>
@endsection

@section('content')
<div class="mb-3 overflow-hidden position-relative">
    <div class="px-3 d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-0 fs-6">Organisations</h4>
      <nav aria-label="breadcrumb">
        <ol class="mb-0 breadcrumb">
          <li class="breadcrumb-item">
            <a href="{{ route('dashboard') }}">Dashboard</a>
          </li>
          <li class="breadcrumb-item" aria-current="page">Organisations</li>
        </ol>
      </nav>
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-body">
      <div class="justify-between mb-2 d-flex">
        <h4 class="mb-0 card-title">Registered Organisations</h4>

        {{-- <div class="ms-auto">
            <a  class="px-4 mb-1 btn bg-success-subtle text-success fs-4 ms-auto me-1" data-bs-toggle="modal" data-bs-target="#createModal" id="#modalCenter">Add Organisation</a>
        </div> --}}
      </div>
    <div class="mb-3 row">

          <div class="p-3 table-responsive">
            <table class="table align-items-center table-flush table-hover" id="client">
...
@section('scripts')
    ...
    <script>
        function openEditModal(id) {
            $.ajax({
                url: '/client/' + id, // Replace with the appropriate route for fetching department details
                type: 'GET',
