    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="member-image-upload" action="{{ route('user.image.upload') }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <input type="hidden" name="member_id" value="{{ Auth()->user()->id }}"> <!-- This holds the member ID -->
